...
const I18n = (() => {
  ...
  const catalog = new Map([
    ['Abrir men\u00fa', 'Open menu'], ['Cerrar men\u00fa', 'Close menu'], ['Men\u00fa', 'Menu'], ['Secciones', 'Sections'], ['Mis hitos', 'My milestones'],
    ['Mi plan', 'My plan'], ['Plan', 'Plan'], ['Plan patrimonial', 'Wealth plan'], ['Metas', 'Goals'],
    ['Calendario', 'Calendar'], ['Historia', 'History'], ['Informes', 'Reports'], ['Alertas', 'Alerts'],
    ['Crear meta', 'Create goal'], ['Editar meta', 'Edit goal'], ['Crear evento', 'Create event'],
    ['Editar evento', 'Edit event'], ['Crear hito', 'Create milestone'], ['Editar hito', 'Edit milestone'],
    ['Agregar hito', 'Add milestone'], ['Fecha objetivo', 'Target date'], ['Monto objetivo', 'Target amount'],
    ['Monto apartado', 'Set aside'], ['Monto apartado manualmente', 'Manually set aside'],
    ['Progreso desde', 'Progress source'], ['Progreso de meta', 'Goal progress'], ['Pausar meta', 'Pause goal'],
    ['Pausada', 'Paused'], ['Alcanzada', 'Reached'], ['Fecha vencida', 'Overdue'], ['Falta', 'Remaining'],
    ['Por mes hasta la fecha', 'Per month until target'], ['Nota', 'Note'], ['Sin metas.', 'No goals.'],
    ...
    ['Cambio neto', 'Net change'], ['Qu\u00e9 movi\u00f3 mi patrimonio', 'What moved my net worth'],
    ['Cambio de cobertura', 'Coverage change'], ['Cambio de saldo', 'Balance change'], ['Proyecci\u00f3n de planilla', 'Payroll projection'],
    ['Cambio en restas', 'Deduction change'], ['Redondeo', 'Rounding'], ['Efecto USD/CRC incluido arriba', 'USD/CRC effect included above'],
    ['No hay dos cortes completos comparables en este periodo.', 'There are not two complete comparable snapshots in this period.'],
    ['Cambio de patrimonio, no rentabilidad. Sin movimientos conciliados no se pueden separar aportes, retiros y ganancias. Las cuentas nuevas o ausentes cambian la cobertura.', 'Net worth change, not investment return. Contributions, withdrawals and gains cannot be separated without reconciled transactions. New or missing accounts change coverage.'],
    ['Todo USD con la selecci\u00f3n de fuentes actual. Cada corte conserva su tipo de cambio; no se rellenan fechas sin datos.', 'All USD using your current source selection. Each snapshot retains its exchange rate; missing dates are not filled.'],
    ['Bit\u00e1cora de hitos', 'Milestone journal'], ['Sin hitos registrados.', 'No milestones recorded.'],
    ['Ficha anual', 'Annual report'], ['Resumen mensual', 'Monthly summary'], ['Informe', 'Report'], ['Periodo', 'Period'],
    ['Mensual', 'Monthly'], ['Anual', 'Annual'], ['Exportar informe privado', 'Export private report'],
    ['Hitos del periodo', 'Period milestones'], ['Sin hitos en este periodo.', 'No milestones in this period.'],
    ['Poder de compra', 'Purchasing power'], ['Referencia de precios', 'Price reference'], ['Estados Unidos', 'United States'],
    ['A\u00f1o del IPC', 'CPI year'], ['Saldo final a precios del a\u00f1o anterior', 'Closing balance at previous-year prices'],
    ['Referencia con IPC promedio anual, no inflaci\u00f3n exacta entre los d\u00edas del informe. No mide rentabilidad. Costa Rica se expresa en CRC con el tipo de cambio del corte final.', 'Annual-average CPI reference, not exact inflation between the report dates. Not an investment return. Costa Rica is expressed in CRC using the closing exchange rate.'],
    ['Metas actuales', 'Current goals'], ['por completar', 'remaining'], ['Pr\u00f3ximas fechas', 'Upcoming dates'], ['Sin fechas pendientes.', 'No upcoming dates.'],
    ['Configurar alertas', 'Configure alerts'], ['Activar avisos', 'Enable alerts'], ['Anticipaci\u00f3n', 'Lead time'],
    ['Avisos dentro de DEX. No se env\u00edan notificaciones con la app cerrada.', 'Alerts inside DEX. No notifications are sent while the app is closed.'],
    ['Sin avisos pendientes.', 'No pending alerts.'], ['Alertas desactivadas.', 'Alerts disabled.'],
    ['Meta alcanzada', 'Goal reached'], ['Fecha objetivo vencida', 'Target date overdue'],
    ['Cuenta vinculada no disponible', 'Linked account unavailable'], ['Fuentes pendientes', 'Sources pending'],
    ['Plan guardado', 'Plan saved'], ['Plan de demostraci\u00f3n', 'Demo plan'],
    ['Cambio de plan pendiente de aplicar en la ejecuci\u00f3n diaria.', 'Plan change pending the daily run.'],
    ['\u00bfEliminar este elemento?', 'Delete this item?'], ['Muestra los importes antes de editar una meta.', 'Reveal amounts before editing a goal.'],
    ['El plan cambi\u00f3. Cierra y actualiza antes de editar.', 'The plan changed. Close and refresh before editing.'],
    ['Revisa monto, fecha y cuenta. No puedes asignar la misma cuenta a dos metas activas.', 'Check the amount, date and account. An account cannot fund two active goals.'],
    ['Guardado sin confirmar. Actualiza antes de reintentar.', 'Save unconfirmed. Refresh before retrying.'], ['No se pudo exportar.', 'Export failed.'],
    ['Apariencia', 'Appearance'], ['Sistema', 'System'], ['Claro', 'Light'], ['Oscuro', 'Dark'],
    ['Total', 'Total'], ['Instalar', 'Install'], ['C\u00f3mo', 'How'], ['Actualizar', 'Update'], ['Instalar DEX', 'Install DEX'],
    ['Instala DEX', 'Install DEX'], ['Pantalla completa y sin conexi\u00f3n', 'Full screen and offline'],
    ['Nueva versi\u00f3n disponible', 'New version available'], ['Reconectando\u2026', 'Reconnecting\u2026'],
    ['Tu patrimonio, claro y privado.', 'Your net worth, clear and private.'], ['Sincronizaci\u00f3n', 'Sync'],
    ['A\u00f1ade DEX a tu inicio', 'Add DEX to your Home Screen'], ['Se abre a pantalla completa y funciona sin conexi\u00f3n.', 'Opens full screen and works offline.'],
    ['Toca Compartir', 'Tap Share'], ['Elige A\u00f1adir a pantalla de inicio', 'Choose Add to Home Screen'], ['Confirma con A\u00f1adir', 'Confirm with Add'],
    ['Precio', 'Price'], ['Valor', 'Value'], ['Ganancia', 'Gain'],
    ...
    ['Solicitud enviada. Pendiente de aplicar.', 'Request sent. Waiting to be applied.'],
    ['Edici\u00f3n remota no disponible. Actualiza el resumen.', 'Remote editing unavailable. Refresh the summary.'],
    ['Autoriza la edici\u00f3n con Google.', 'Authorize editing with Google.'],
    ['Hay un cambio pendiente. Actualiza antes de editar de nuevo.', 'A change is pending. Refresh before editing again.'],
    ['Datos privados en Google Sheets. Importaciones de solo lectura.', 'Private data in Google Sheets. Read-only imports.'],
    ['Vuelve a conectar con Google.', 'Reconnect with Google.'],
    ['Google no autoriz\u00f3 el acceso. Revisa la cuenta y los permisos.', 'Google did not authorize access. Check the account and permissions.'],
    ['Cola de cambios no disponible.', 'Request queue unavailable.'],
    ['Ya hay un env\u00edo en curso.', 'A request is already being sent.'],
    ['Se alcanz\u00f3 el l\u00edmite de solicitudes.', 'Request limit reached.'],
    ['Env\u00edo sin confirmar. Actualiza; reintentar esta misma solicitud no la duplica.', 'Delivery unconfirmed. Refresh; retrying this same request will not duplicate it.'],
  ...
  const patterns = [
    [/^(?:Fecha objetivo en |En )?(\d+) d\u00edas$/, count => `${count} days`],
    [/^IPC (\d{4}) \u00b7 (\d{4})$/, (first, last) => `CPI ${first} \u00b7 ${last}`],
    [/^IPC (\d{4}): pendiente de publicaci\u00f3n o descarga\.$/, year => `Annual CPI ${year}: publication or download pending.`],
    [/^Estado al consultar el informe \((.+)\), no al cierre hist\u00f3rico\.$/, date => `Status when viewing this report (${date}), not at the historical closing date.`],
    [/^Cortes disponibles: (.+) a (.+)\. Puede ser un periodo parcial\.$/, (first, last) => `Available snapshots: ${first} to ${last}. This may be a partial period.`],
    [/^(\d+) cuenta\(s\) con corte de hace m\u00e1s de 45 d\u00edas$/, count => `${count} account(s) with snapshots older than 45 days`],
